...
//
// Two departures from the upstream text, so a re-sync diff is expected to show them:
// meta/v1 is spelled metav1 rather than upstream's v1, and the bare return each
// DeepCopyInto ended with is dropped, since staticcheck flags it (S1023).
